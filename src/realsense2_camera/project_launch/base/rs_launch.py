...
def generate_launch_description():
    ldes=declare_configurable_parameters(configurable_parameters)
    ldes+=[OpaqueFunction(function=launch_setup, kwargs = {'params' : set_configurable_parameters(configurable_parameters)})]
