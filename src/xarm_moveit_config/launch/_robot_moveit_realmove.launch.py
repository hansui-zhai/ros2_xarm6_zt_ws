...
def launch_setup(context, *args, **kwargs):
    ...
    # 这里添加一下修改，看看 默认的 moveit_config 是什么
    # print("保存配置")
    # moveit_config_yaml=yaml.dump(moveit_config.to_dict())
    # with open('/home/allen/02_Project/ros2_workspace/P03_xarm6_workspace/moveit_config.yaml', 'w') as file:
    #     file.write(moveit_config_yaml)
